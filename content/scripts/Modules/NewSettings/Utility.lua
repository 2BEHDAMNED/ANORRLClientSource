...
local function CreateDropDown(dropDownStringTable, startPosition, settingsHub)
	...
	local DropDownFullscreenFrame = Util.Create'ImageButton'
	{
		...
		BorderSizePixel = settingsHub.ZIndex + 10,
		Size = UDim2.new(1, 0, 1, 0),
		BackgroundColor3 = Color3.new(0,0,0),
		ZIndex = settingsHub.ZIndex + 10,
		Active = true,
		Visible = false,
		Selectable = false,
		AutoButtonColor = false,
...
local function ShowAlert(alertMessage, okButtonText, settingsHub, okPressedFunc, hasBackground)
	...
	local AlertViewBackingCore = Util.Create'Frame'
	{
		Name = "AlertViewBacking",
		BackgroundTransparency = 0.2,
		BackgroundColor3 = Color3.new(0,0,0),
		ZIndex = settingsHub.ZIndex + 9,
		Size = UDim2.new(1,0,1,0),
		Parent = CoreGui.ANORRLGui
	};
	...
	AlertViewButton.ZIndex = settingsHub.ZIndex + 10
